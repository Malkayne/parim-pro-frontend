...
import type { CreateEventInput } from './eventsApi';
...
export function CreateEventDialog({ open, submitting, onClose, onSubmit }: Props) {
      ...
      <div className="w-full max-w-2xl rounded-xl border border-border bg-card shadow-sm">
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          <div>
            ...
            <div className="text-xs text-muted-foreground">Draft by default</div>
          </div>
