...
export function PageHeader({ title, description, breadcrumbs, actions, banner, hideHeader }: Props) {
  return (
    <div className="space-y-4">
      {!hideHeader && (
        <div className="rounded-xl border border-border bg-card px-5 py-4 bg-primary/10">
